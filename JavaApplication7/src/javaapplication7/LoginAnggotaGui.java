 ...
 */
public class LoginAnggotaGui extends javax.swing.JFrame {

    /**
     * Creates new form LoginAnggotaGui
     */
    public LoginAnggotaGui() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginAnggotaGui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginAnggotaGui().setVisible(true);
            }
        });
    }
